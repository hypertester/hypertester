...
action do_update_hp##idx##_stage1_dgst_empty() { \
...
table hp##idx##_update_stage1_when_empty { \
	actions { \
		do_update_hp##idx##_stage1_dgst_empty; \
	} \
	size : 1; \
} \
...
action do_update_hp##idx##_stage2_dgst_empty() { \
...
table hp##idx##_update_stage2_when_empty { \
	actions { \
		do_update_hp##idx##_stage2_dgst_empty; \
	} \
	size : 1; \
} \
